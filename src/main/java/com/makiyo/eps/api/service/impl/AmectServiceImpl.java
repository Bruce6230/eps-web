...
//import com.makiyo.eps.api.dao.TbAmectDao;
//import com.makiyo.eps.api.exception.EpsException;
//import com.makiyo.eps.api.pojo.TbAmect;
//import com.makiyo.eps.api.service.AmectService;
//import com.makiyo.eps.api.utils.PageUtils;
//import com.makiyo.eps.api.wxpay.MyWXPayConfig;
//import com.makiyo.eps.api.wxpay.WXPay;
//import com.makiyo.eps.api.wxpay.WXPayUtil;
...
//                    if(rows!=1){
//                        throw new EpsException("更新罚款单的支付订单ID失败");
//                    }
...
//                    throw new EpsException("创建支付订单失败");
//                }
//            }catch (Exception e){
...
//        }
//        else{
//            throw new EpsException("没有找到罚款单");
//        }
//    }
//
//    @Override
